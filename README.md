...
This repository extends the official [torchtune](https://github.com/pytorch/torchtune) framework by modifying torchtune's  implementations for single device knowledge distillation and KL divergence with **open-source contributions** aimed at improving flexibility, transparency, and performance.
